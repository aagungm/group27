...
var firstImage = jQuery('#first').data('background-image');
var secondImage = jQuery('#second').data('background-image');
var thirdImage = jQuery('#third').data('background-image');
var ourTeamImage = jQuery('#ourteam').data('background-image');
var problemsImage = jQuery('#problems').data('background-image');
...
if (firstImage) {  jQuery('#first').css({ 'background-image':'url(' + firstImage + ')' }); };
if (secondImage) {  jQuery('#second').css({ 'background-image':'url(' + secondImage + ')' }); };
if (thirdImage) {  jQuery('#third').css({ 'background-image':'url(' + thirdImage + ')' }); };
if (ourTeamImage) {  jQuery('#ourteam').css({ 'background-image':'url(' + ourTeamImage + ')' }); };
if (problemsImage) {  jQuery('#problems').css({ 'background-image':'url(' + problemsImage + ')' }); };
...
jQuery(document).ready(function($) {
    ...
    $('.next-section .go-to-first').click(function() {
        $('html,body').animate({scrollTop:$('#first').offset().top}, 1000);
    });
    $('.next-section .go-to-second').click(function() {
        $('html,body').animate({scrollTop:$('#second').offset().top}, 1000);
    });
    $('.next-section .go-to-third').click(function() {
        $('html,body').animate({scrollTop:$('#third').offset().top}, 1000);
    });
  	$('.next-section .go-to-page-top').click(function() {
    	$('html,body').animate({scrollTop:$('#page-top').offset().top}, 1000);
  	});
    $('.next-section .go-to-ourteam').click(function() {
        $('html,body').animate({scrollTop:$('#ourteam').offset().top}, 1000);
    });
